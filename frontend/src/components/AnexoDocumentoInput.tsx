...
interface AnexoDocumentoInputProps {
  value: File | null
  onChange: (file: File | null) => void
}

export default function AnexoDocumentoInput({ value, onChange }: AnexoDocumentoInputProps) {
  ...
  return (
    <div className="space-y-2">
      <div className="flex gap-2">
        ...
        <button type="button" className="btn-secondary flex-1" onClick={() => documentoRef.current?.click()}>
          📄 Anexar Documento
        </button>
      </div>
