...
const PROMPT_PECA = `Esta é uma foto de uma peça, matéria-prima ou item do almoxarifado de uma empresa de equipamentos em aço inox (Mirainox) — pode ser a peça em si, uma etiqueta, uma nota ou uma embalagem. Extraia: nome da peça, categoria/tipo, quantidade, valor unitário e unidade de medida.
